...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>GR Store</strong><br>
                Estrada dos Bandeirantes, 11609 - Vargem Pequena<br>
                Rio de Janeiro - RJ<br>
                Telefone: (21) 3333-3333<br>
                E-mail: suporte.ericdev@gmail.com
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
