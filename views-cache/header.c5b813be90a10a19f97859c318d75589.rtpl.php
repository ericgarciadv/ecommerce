                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li class="btn" disabled="disabled"><a href="#"><i class="fa fa-heart"></i> Lista de Desejos</a></li>
                ...
                <div class="col-md-4">
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small btn" disabled="disabled">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="/"><span>Gr</span> Store</a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class=<?php echo isHomeMenuActive(); ?>><a href="/">Home</a></li>
                        <li class=<?php echo isProductsMenuActive(); ?>><a href="/products">Produtos</a></li>
                        <li class=<?php echo isCartMenuActive(); ?>><a href="/cart">Carrinho</a></li>
                    </ul>
                </div>  
            </div>
        </div>
